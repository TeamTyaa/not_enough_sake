...
class TasteAxis {
  ...
  const TasteAxis({
    ...
    required this.left,
    required this.right,
    required this.simpleLeft,
    required this.simpleRight,
  });
}

const List<TasteAxis> kAxes = [
  TasteAxis(
      key: 'sweet', emoji: '🍯', left: 'もっと甘い方が好き', right: 'もっと辛い方が好き', simpleLeft: '甘いのが好き', simpleRight: '辛いのが好き'),
  TasteAxis(
      key: 'body', emoji: '🌊', left: 'もっと軽い方が好き', right: 'もっと濃厚な方が好き', simpleLeft: '軽いのが好き', simpleRight: '濃厚なのが好き'),
  TasteAxis(
      key: 'aroma',
      emoji: '🌸',
      left: 'もっとフルーティな方が好き',
      right: 'もっとどっしりした香りが好き',
      simpleLeft: 'フルーティな香りが好き',
      simpleRight: 'どっしりした香りが好き'),
  TasteAxis(
      key: 'finish',
      emoji: '✨',
      left: 'もっとすっきりした方が好き',
      right: 'もっとコクが残る方が好き',
      simpleLeft: 'すっきりしたのが好き',
      simpleRight: 'コクが残るのが好き'),
  TasteAxis(
      key: 'kick',
      emoji: '🔥',
      left: 'もっとまろやかな方が好き',
      right: 'もっとキリッとした刺激が好き',
      simpleLeft: 'まろやかなのが好き',
      simpleRight: 'キリッとした刺激が好き'),
];
