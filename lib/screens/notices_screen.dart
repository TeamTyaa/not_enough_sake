...
class NoticesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: nomigatorAppBar(title: 'お知らせ',
        onBack: () => Navigator.of(context).pop()),
      body: active.isEmpty
        ? const Center(child: Text('現在お知らせはありません',
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: kCard,
                    border: Border.all(
                      color: isRead ? kBorder : kGold.withOpacity(.3)),
                    ...
                    Row(children: [
                      ...
                      Expanded(child: Text(notice.title,
                        style: TextStyle(fontSize: 15,
                          color: isRead ? kMuted : kText))),
                    ]),
                    const SizedBox(height: 8),
                    Text(notice.body,
                      style: const TextStyle(fontSize: 12, color: kDim, height: 1.75)),
                    const SizedBox(height: 10),
                    Text('掲載期限: ${notice.endAt}',
