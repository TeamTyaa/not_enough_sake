...
import 'nomikai_board_screen.dart';
      ...
      appBar: AppBar(
        ...
        title: RichText(text: const TextSpan(
          ...
          children: [
            ...
            TextSpan(text: 'N', style: TextStyle(
              color: kGold, fontStyle: FontStyle.italic,
            )),
          ],
        )),
        actions: [
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: Row(children: [
              _TabButton(
                label: 'おすすめ', selected: _tabIndex == 0,
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Text(
          ...
          style: TextStyle(
            ...
            color: selected ? kGold : locked ? const Color(0xFF2a2018) : kDim,
          ),
        ),
        if (locked) const Text(' 🔒',
          style: TextStyle(fontSize: 8, color: Color(0xFF3a3028))),
      ]),
    ),
  );
}
...
class _AppDrawer extends ConsumerWidget {
  ...
  const _AppDrawer({
    required this.freeTokens, required this.paidTokens,
    required this.unreadCount, required this.onNavigate, required this.user,
  });
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            const Text('MENU', style: TextStyle(
              fontSize: 12, letterSpacing: 2, color: kDim,
            )),
            IconButton(
        ...
        Container(
          ...
          child: Row(children: [
            RichText(text: TextSpan(children: [
              TextSpan(text: '$freeTokens',
                style: const TextStyle(fontSize: 15, color: kGold)),
              const TextSpan(text: '  合',
                style: TextStyle(fontSize: 10, color: kDim)),
            ])),
            const SizedBox(width: 24),
            RichText(text: TextSpan(children: [
              TextSpan(text: '$paidTokens',
                style: const TextStyle(fontSize: 15, color: Color(0xFFc07a5a))),
        ...
        Expanded(
          child: ListView(padding: EdgeInsets.zero, children: [
            _DrawerItem(
              icon: '🔔', label: 'お知らせ', badge: unreadCount,
    ...
    title: Row(children: [
      ...
      if (badge > 0) ...[
        ...
        Container(
          ...
          child: Text('$badge',
            style: const TextStyle(fontSize: 10, color: kBg)),
        ),
      ],
    ]),
