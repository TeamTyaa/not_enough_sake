...
class _UserProfileScreenState extends State<UserProfileScreen> {
              ...
              ..._favs.take(5).toList().asMap().entries.map((entry) {
                ...
                return Container(
                  ...
                  decoration: const BoxDecoration(
                    border: Border(bottom: BorderSide(color: Color(0xFF1a1816)))),
                  child: Row(children: [
                    SizedBox(
                      width: 24,
                      child: Text('${i+1}', textAlign: TextAlign.center,
                        style: TextStyle(
                          ...
                          color: i==0 ? kGold : i==1
                            ? const Color(0xFF9a9a9a) : i==2
                            ? const Color(0xFFc07a5a) : kDim,
                        )),
                    ),
                    ...
                    ClipRRect(
                      ...
                      child: DrinkImage(
                        name: fav.name, category: fav.category,
                        height: 44, width: 44,
                      ),
                    ),
                    const SizedBox(width: 12),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      Wrap(spacing: 5, runSpacing: 4, children: [
                        ...
                        if (h.justRight) const CategoryTag('⭐ お気に入り',
                          color: Color(0xFF7aaa6a)),
                      ]),
                      const SizedBox(height: 6),
                      ...
                      const SizedBox(height: 6),
                      Text(h.text, style: const TextStyle(
                        fontSize: 12, color: kMuted, height: 1.7)),
                    ]),
                  ),
                ]),
              )),
              ...
              if (_visibleCount >= _reviews.length && _reviews.isNotEmpty)
                const Center(child: Padding(
                  ...
                  child: Text('すべて表示しました',
                    style: TextStyle(fontSize: 10, color: Color(0xFF2a2018),
                      letterSpacing: 2)),
                )),
            ],
          ],
  ...
  int _getAxisValue(TasteProfile s, String key) {
    switch (key) {
      case 'sweet':  return s.sweet;
      case 'body':   return s.body;
      case 'aroma':  return s.aroma;
      case 'finish': return s.finish;
      case 'kick':   return s.kick;
      default:       return 0;
    }
  }
}
