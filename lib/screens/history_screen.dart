...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: nomigatorAppBar(title: 'レビュー履歴',
...
class _HistoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: const Color(0xFF0a0806), border: Border.all(color: kBorder),
      ...
      Padding(padding: const EdgeInsets.all(12), child:
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Wrap(spacing: 5, runSpacing: 4, children: [
            ...
            if (review.justRight) const CategoryTag('⭐ お気に入り',
          ...
          const SizedBox(height: 6),
          Text(review.text,
            style: const TextStyle(fontSize: 12, color: kMuted, height: 1.7)),
          const SizedBox(height: 6),
