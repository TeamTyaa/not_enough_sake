...
class FavoritesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: nomigatorAppBar(title: 'お気に入りランキング',
      ...
      body: Column(children: [
        ...
        Expanded(
          child: favs.isEmpty
            ? const Center(child: Text('まだお気に入りがありません',
                    ...
                    child: Row(children: [
                      SizedBox(
                        ...
                        child: Stack(children: [
                          DrinkImage(name: fav.name, category: fav.category,
                            height: 60, width: 60),
                          Positioned(top: 3, left: 5, child: Text('${i+1}',
                            style: TextStyle(
                              fontSize: 14, fontStyle: FontStyle.italic,
                              color: i==0?kGold:i==1?const Color(0xFF9a9a9a)
                                :i==2?const Color(0xFFc07a5a):kDim,
