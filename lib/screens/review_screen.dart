...
class ReviewScreen extends StatefulWidget {
  ...
  const ReviewScreen({
    super.key, required this.drink, required this.tierLabel,
    required this.uid, required this.onSaved,
  });
        ...
        if (_justRight)
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: kGold.withOpacity(.25)),
            ),
            child: const Text(
