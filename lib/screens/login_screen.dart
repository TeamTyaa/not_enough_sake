        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              const Text('NOMIGATORI-N',
                style: TextStyle(fontSize: 10, letterSpacing: 5, color: kDim)),
              const SizedBox(height: 8),
              const Text('のみがたりえぬ ── 呑みが足りん',
                style: TextStyle(fontSize: 12, color: Color(0xFF4a3a28))),
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
            ...
            style: const TextStyle(
              color: Color(0xFF1a1510), fontSize: 14,
...
class _GoogleLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void arc(Color c, double start, double sweep) {
      final paint = Paint()
        ..color = c ..style = PaintingStyle.stroke ..strokeWidth = r * 0.4;
      canvas.drawArc(
    ...
    final barPaint = Paint()
      ..color = const Color(0xFF4285F4) ..strokeWidth = r * 0.4;
    canvas.drawLine(
      Offset(r, r), Offset(size.width * 0.95, r), barPaint,
    );
  }
